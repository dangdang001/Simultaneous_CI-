...
for(k in 1:ksce){
  ...
  simu.one.PAR.mpi <- function(i=1,k,mu.R1,mu.R2,mu.T,sd.R1,sd.R2,sd.T,n){
  ...
  system.time(out.tmp.cont <- sapply(1:repet, simu.one.PAR.mpi, k=k,mu.R1=mu.R1,mu.R2=mu.R2,mu.T=mu.T,sd.R1=sd.R1,sd.R2=sd.R1,sd.T=sd.T,n=n))
