# Purpose: Generating Pairwise method and Simu CI method result, mu_R1=99, mu_R2=101, mu_T=100
# Name: Donglei Yin
# Date: 2018.07
...
write.csv(Arcd, paste("Arcd_n",n,"_",mu.R1,"_",mu.R2,"_",mu.T,"_equal_var","_sdR1_",round(sd.all[1],2),"_",round(sd.all[ksce],2),"_rp",repet,".csv",sep=""))
write.csv(summ, paste("summ_n",n,"_",mu.R1,"_",mu.R2,"_",mu.T,"_equal_var","_sdR1_",round(sd.all[1],2),"_",round(sd.all[ksce],2),"_rp",repet,".csv",sep=""))
